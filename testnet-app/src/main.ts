  ...
  root.innerHTML = `
    <div class="lab-shell">
      <header class="site-header">
        ...
        <nav aria-label="Main navigation"><a href="/dashboard/">DASHBOARD</a><a href="https://rarerush.app/arcade/" class="arcade-link">TRY ARCADE</a><a href="/play/" class="outline-link play-link">PLAY TESTNET <span aria-hidden="true">↗</span></a></nav>
      </header>
      <main>

...
function Header() {
  return <header className="genesis-header"><a className="genesis-logo" href="/" aria-label="Rare Rush by Xibot home"><BrandMark/></a><nav aria-label="Main navigation"><a href="/pitch/">PITCH</a><a href="/docs/">DOCS ↗</a></nav></header>;
}

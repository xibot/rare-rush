...
function Docs() {
  ...
  return <div className="rush-docs" id="top">
    ...
    <header className="docs-header"><a className="docs-logo" href="/" aria-label="Rare Rush by Xibot home"><BrandMark/></a><nav aria-label="Main navigation"><a href="/">HOME</a><a className="docs-cta" href="/arcade/">ENTER ARCADE ↗</a></nav></header>
    <main>

...
export const tokenAbi = parseAbi([
  ...
  'function launchAllocation() view returns (uint256)',
...
export const gameAbi = parseAbi([
  ...
  'function expectedLaunchAllocation() view returns (uint256)',
  'function INITIAL_COIN_REWARD() view returns (uint256)',
  'function MIN_COIN_REWARD() view returns (uint256)',

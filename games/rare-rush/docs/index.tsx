      ...
      <div className="docs-layout">
        ...
        <div className="docs-content">
          <section className="docs-section" id="start" aria-labelledby="start-title"><div className="section-kicker">01 / YOUR FIRST RUSH</div><div className="section-heading"><h2 id="start-title">Ready. Set. Rare.</h2><p>An endless world. A very finite timer. Grab coins, dodge trouble, and see how far your Friend can go.</p></div>
            ...
            <p className="docs-note">Genesis keeps your original face and picks a random body from 36 compatible Generations bodies at the start of each run, avoiding the previous body. Your look stays fixed until the next run. Bodies change the animation, not the collision area, movement rules, or rewards. <a href="/genesis-lab/">Try Genesis in Motion: sprites, moves, and a new body with every roll ↗</a></p>
          </section>

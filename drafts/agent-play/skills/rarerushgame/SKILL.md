...
Read this skill at https://rarerush.app/agent-skill/SKILL.md and its reference at https://rarerush.app/agent-skill/references/jobs.md. Install both in the agent’s skill loader, or use the whole `drafts/agent-play/skills/rarerushgame/` folder from https://github.com/xibot/rare-rush. Keep that repository checkout containing `drafts/agent-play/cli.mjs` available for execution. No scheduler or wallet is configured by installing the skill.
...
```sh
node drafts/agent-play/cli.mjs publish --job /absolute/path/to/jobs/rr-arcade-genesis-42-normal-20260924t1200z.json
```

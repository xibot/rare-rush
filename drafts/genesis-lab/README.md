...
The production build has no entry point, HTML copy, or route for this directory, and `.vercelignore` excludes all drafts from deployment uploads. The old showcase output is removed when rebuilding an existing output directory. Public links to the page have been removed.
